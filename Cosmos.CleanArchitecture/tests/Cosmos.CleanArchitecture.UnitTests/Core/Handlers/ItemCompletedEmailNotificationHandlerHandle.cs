...
using Cosmos.CleanArchitecture.Core.ProjectAggregate.Events;
using Cosmos.CleanArchitecture.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace Cosmos.CleanArchitecture.UnitTests.Core.Handlers;
